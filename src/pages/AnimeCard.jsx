      ...
      <div className={styles.animeCard}>
        ...
        <div className={styles.animeInformationsContainer}>
          ...
          <Typography className={styles.subtitle} color="text.secondary">
            ...
            beating mob monsters to a pulp, she has a chance encounter with
            Akito Yamada, a guildmate with an afro and Noh mask. Yamada is
            unsociable and curt, hardly the type of person to make Akane swoon.
            However, while his gaming stats might be maxed out, Yamada is
            inexperienced in matters of the heart, and against all odds, she
            finds herself moved by him. Making new friends along the way, can
